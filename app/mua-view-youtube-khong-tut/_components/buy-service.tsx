...
export default function BuyServiceForm() {
  ...
  // Hàm render tin tức sử dụng chuỗi HTML với dangerouslySetInnerHTML
          ...
          <div className="grid grid-cols-1 gap-5 md:gap-6">
            ...
            <CardContent className="w-full rounded-lg p-3 md:p-4 py-2 mb-1 md:mb-2 px-3 md:px-4">
              <div className="bg-blue-100 p-3 md:p-4 rounded-lg">
                ...
                <ul className="space-y-1 md:space-y-2 text-[#D82222] text-xs md:text-sm font-semibold font-sans mb-3 md:mb-4">
                ...
                <ul className="space-y-1 md:space-y-2 text-[#D82222] text-xs md:text-sm font-semibold font-sans mt-2">
